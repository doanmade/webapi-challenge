...
- light weight, simple, and un-opinionated
- [ ] Describe Middleware?
      middleware is an array of function that you trigger in the order they are introduces to the server code

- [ ] Describe a Resource?
      this is a very open question. but some resources are things like google, tk, youtube
      i would describe it as being a source of knowledge used to complete our task

- [ ] What can the API return to help clients know if a request was successful?
      server codes and messages

- [ ] How can we partition our application into sub-applications?
      using routes and custom middleware
